      ...
      return (
        <Html lang='en'>
          ...
          <body style="overflow-y: hidden;">
            ...
            <!-- Navbar Bottom -->
            <nav class="navbar navbar-light bg-light navbar-expand fixed-bottom rounded-top-4 p-0" id="navbar-menus">
            ...
            <main class="text-light" data-bs-spy="scroll" data-bs-target="#navbar-menus" data-bs-root-margin="0px 0px -40%"
                ...
                <section class="container" id="home">
                    ...
                    <div class="text-center pt-4">
                        ...
                        <div class="py-4">
                            <div class="img-crop  shadow mx-auto">
                                <img src="/assets/images/bg.png" alt="bg" onclick="util.modal(this)">
                            </div>
                        </div>
        
                        <h1 class="font-esthetic my-4" style="font-size: 3rem;">Afroz & Nafisha</h1>
                    ...
                    <div class="text-center">
                        ...
                        <div class="overflow-x-hidden">
                            ...
                            <div data-aos="fade-right" data-aos-duration="2000">
                                ...
                                <h1 class="font-esthetic" style="font-size: 3rem;">Afroz Sorathiya</h1>
                                <h5 class="mt-3 mb-0">Son</h5>
                                <p class="mb-0">Mr. & Mrs. Sorathiya</p>
                            </div>
                            ...
                            <div data-aos="fade-left" data-aos-duration="2000">
                                ...
                                <h1 class="font-esthetic" style="font-size: 3rem;">Nafisha Sorathiya</h1>
                                <h5 class="mt-3 mb-0">Daughter</h5>
                                <p class="mb-0">Mr. & Mrs. Sorathiya</p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="dark-section" id="date">
                    ...
                    <div class="container">
                        <div class="text-center">
                            ...
                            <h1 class="font-esthetic py-3" style="font-size: 2rem;">Time to Event</h1>
                            <div class="border rounded-pill shadow py-2 px-3 mx-2 mb-4">
        
                                <!-- Replace the time with time-data (according to the format) -->
                                <div class="row justify-content-center" time-data="2023-12-03 10:00:00" id="time-display">
                                    <div class="samll-font col-2 p-1 ps-2">
                                        <h2 class="d-inline m-0 p-0" id="day">0</h2><small
                                            class="ms-1 me-0 my-0 p-0 d-inline">Day</small>
                                    </div>
                                    <div class="samll-font col-3 p-1">
                                        <h2 class="d-inline m-0 p-0" id="hours">0</h2><small
                                            class="ms-1 me-0 my-0 p-0 d-inline">Hours</small>
                                    </div>
                                    <div class="samll-font col-3 p-1">
                                        <h2 class="d-inline m-0 p-0" id="minutes">0</h2><small
                                            class="ms-1 me-0 my-0 p-0 d-inline">Minutes</small>
                                    </div>
                                    <div class="samll-font col-4 p-1">
                                        <h2 class="d-inline m-0 p-0" id="seconds">0</h2><small
                                            class="ms-1 me-0 my-0 p-0 d-inline">Seconds</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="overflow-x-hidden">
                                <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
                                    <h1 class="font-esthetic" style="font-size: 2rem;">Wedding start at</h1>
                                    <p>10:00 AM </p>
                                </div>
        
                                <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                                    <h1 class="font-esthetic" style="font-size: 2rem;">End at</h1>
                                    <p>02:00 PM</p>
                                </div>
                            </div>
            ...
            <footer>
                <div class="container">
                    <div class="text-center">
                        ...
                        <h1 class="font-esthetic" data-aos="fade-up" data-aos-duration="2000">Waalaikumassalam Warahmatullahi
                            Wabarakatuh</h1>
                        ...
                        <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                            <div class="col-auto">
                                <small class="text-light">
                                    Build with<i class="fa-solid fa-heart mx-1"></i>Afroz Sorathiya
                                </small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="loading-page" id="welcome" style="opacity: 1;">
                <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
                    ...
                    <div class="text-center">
                        ...
                        <div class="img-crop shadow mb-4 mx-auto">
                            <img src="/assets/images/bg.png" alt="bg">
                        </div>
        
                        <!-- <h1 class="font-esthetic my-4" style="font-size: 2.5rem;">Afroz &nbsp; & &nbsp; Nafisha</h1> -->
        
                        <button type="button" class="btn btn-light shadow rounded-4 mt-4" onclick="util.open()">
                            <i class="fa-solid fa-envelope-open me-2"></i>View Invitation
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- Audio Button -->
            <button type="button" id="music-button" style="display: none;" class="btn btn-light btn-sm rounded-circle btn-music"
            ...
            <div class="loading-page" id="loading" style="opacity: 1;">
                <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
                    <div class="text-center w-75">
                        <img class="img-fluid mb-3" src="/assets/images/favicon-32x32.png" alt="icon" style="width: 3.5rem;">
                        <div class="progress" role="progressbar" style="height: 0.5rem;">
                            <div class="progress-bar" id="bar" style="width: 0%"></div>
                        </div>
                        <small class="mt-1 text-light" id="progress-info">Loading Invitation</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                                <img src="/assets/images/bg.png" class="w-100" alt="foto" id="show-modal-image">
                            </div>
                        </div>
                    </div>
                </div>
